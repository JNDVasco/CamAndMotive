...
for(
int iChannel = 0;
iChannel<data->ForcePlates[iPlate].
nChannels;
iChannel++)
{
...
for(
int iSample = 0;
iSample<data->ForcePlates[iPlate].ChannelData[iChannel].
nFrames;
iSample++)
...
for (
int iSample = 0;
iSample<data->Devices[iDevice].ChannelData[iChannel].
nFrames;
iSample++)
